...
**fullpage-bg:** Similar to above, but doesn't start a new side and inserts the image as the background of the current page.
...
You can use a json file with monster stats and codeblocks with the monster class to show them. You could also give the monster stats directly as json in one such codeblock. This supports images, if they are given in the json. Of course you can also just format them yourself. 
...
![](assets/images/wizard.png){.bottom-right}
:::
...
Ea cillum aliquip amet veniam tempor et culpa ipsum non. Eiusmod adipisicing eu reprehenderit eu ut sunt eu. Do sunt fugiat laboris irure ut. Laborum eu non minim sunt sit. Ullamco minim anim irure dolor fugiat pariatur culpa id consequat in in. Magna dolore ad nisi tempor do adipisicing ex ea et Lorem amet elit.
