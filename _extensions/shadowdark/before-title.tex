...
\usepackage[%
  ...
  top=$pagesizes.top$+\sdBleed,
  bottom=$pagesizes.bottom$+\sdBleed,
  left=$pagesizes.left$+\sdLeftAdjust,
  right=$pagesizes.right$+\sdRightAdjust
]{geometry}
...
\newcommand{\shadowdarkTitlePage}{%
  ...
  \newgeometry{left=21mm+$pagesizes.left$+\sdLeftAdjust,right=22mm+$pagesizes.right$+\sdRightAdjust, top=2.5cm+\sdBleed, bottom=1.25cm+\sdBleed}
