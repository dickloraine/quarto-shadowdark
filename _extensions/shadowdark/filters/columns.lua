...
local function format_colspan_latex(elem, number_columns)
    ...
    local unbalanced = options.unbalanced
...
local function format_columns_latex(elem)
  ...
  if elem.classes:includes('balanced') then
    latex_begin = latex_begin ..
      "\\begin{multicols}{" .. number_columns .. "}\n"
    latex_end = "\\end{multicols}\n" .. latex_end
  elseif unbalanced or elem.classes:includes('unbalanced') then
    latex_begin = latex_begin ..
      "\\begin{multicols*}{" .. number_columns .. "}\n"
    latex_end = "\\end{multicols*}\n" .. latex_end
  else
...
read_options_filter = {
  Meta = function (meta)
    ...
    if meta.unbalanced or meta['unbalanced'] then
